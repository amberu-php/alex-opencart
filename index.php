...
amberuSetSessionPricelist($config->get('config_amberu_pricelists'), $customer->getGroupId());
amberuSetSessionCart($config->get('config_amberu_pricelists'), $customer->getGroupId());
//debug
//unset($_SESSION['amberu_cart']['pricelist_number']);
