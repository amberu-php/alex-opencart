...
class ModelSettingSetting extends Model {
	...
	public function editSetting($code, $data, $store_id = 0) {
		...
		//AMBERU
		if (isset($data['config_amberu_pricelists'])) {
			foreach($data['config_amberu_pricelists'] as $key => $amberu_pricelist) {
				if (($amberu_pricelist['order_limit'] == '') || ($amberu_pricelist['order_limit'] == null)) {
					$data['config_amberu_pricelists'][$key]['order_limit'] = 0.00;
				}
			}
		}
