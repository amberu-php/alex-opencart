...
class ControllerCatalogOption extends Controller {
	...
	//AMBERU
	public function amberuGetOptionValues() {
		$json = array();
		...
		if ($this->request->post['option_id']) {
			...
			$option = $this->model_catalog_option->getOption($this->request->post['option_id']);
		...
		$json['amberu_text_missing'] = $this->language->get('amberu_text_missing');
