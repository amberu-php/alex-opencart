...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		//AMBERU
		$data['tab_amberu_multiprice'] = $this->language->get('tab_amberu_multiprice');
		...
		//amberu
		if (isset($this->request->post['config_amberu_pricelists'])) {
			$data['config_amberu_pricelists'] = $this->request->post['config_amberu_pricelists'];
		} else {
			$data['config_amberu_pricelists'] = $this->config->get('config_amberu_pricelists');
		}
