							...
							<div id="tab-general" class="tab-pane">
								...
								<div class="tab-pane" id="tab-language-<?php echo $language['language_id']; ?>">
									<table class="table">
										...
										<tr>
											<td><?php echo $objlang->get('entry_tags');?></td>
												<td>
													<input class="form-control" type="text" name="pavblog_blog_description[<?php echo $language['language_id'];?>][lang_tags]" value="<?php echo $pavblog_blog_descriptions[$language['language_id']]['lang_tags'];?>" size="120">
													<p><i><?php echo $objlang->get('text_explain_tags');?></i></p>
											</td>
										</tr>
...
<script type="text/javascript">
	...
	<?php foreach ($languages as $language) { ?>
  <?php if ($ckeditor) { ?>
  ckeditorInit('pavblog_blog_description_title_lang<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
  ckeditorInit('pavblog_blog_description_des_lang<?php echo $language['language_id']; ?>', '<?php echo $token; ?>');
  <?php } else { ?>
