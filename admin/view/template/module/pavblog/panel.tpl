								...
								<ol>	
									<li>
										<div><b><?php echo $objlang->get('text_front_page');?></b></div>
										 ...
										 <?php echo $objlang->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?route=pavblog/category=1";?><br>
									...
									<li>
										...
										<?php echo $objlang->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?route=pavblog/category=";?>CATEGORY_ID <br>
										<?php echo $objlang->get('text_seo');?>: <?php echo HTTPS_CATALOG.'<b>Category - Keyword</b>';?>	
									</li>
									<li>
										<div><b><?php echo $objlang->get('text_item_page')?></b>: </div>
										<?php echo $objlang->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?route=pavblog/blog=";?>BLOG_ID<br>
										<?php echo $objlang->get('text_seo');?>: <?php echo HTTPS_CATALOG.'<b>Blog - Keyword</b>';?>	
									</li>
									
									<li>
										<div><b><?php echo $objlang->get('text_filter_blog');?></b></div>
										<?php echo $objlang->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?route=pavblog/category&tag=";?><b>TAG_NAME</b><br>
