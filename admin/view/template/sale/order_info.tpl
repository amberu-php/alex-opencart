    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <ul class="nav nav-tabs">
		  ...
		  <!--//AMBERU-->
		  <li><a href="#tab-amberu-note" data-toggle="tab"><?php echo $amberu_text_amberu_note; ?></a></li>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-order">
            <table class="table table-bordered">
			  ...
			  <!--//AMBERU-->
			  <?php if ($amberu_pricelist_number > 0) { ?>
              <tr>
                <td><?php echo $amberu_text_pricelist_number; ?></td>
                <td><?php echo '№' . $amberu_pricelist_number . ': ' . $amberu_text_order_limit; ?></td>
              </tr>
			  <?php } else { ?>
			  <tr>
                <td><?php echo $amberu_text_pricelist_number; ?></td>
                <td><?php echo 'Отсутствует = ' . $amberu_text_retail; ?></td>
              </tr>
			  <?php } ?>
		  ...
		  <div class="tab-pane" id="tab-amberu-note">
		    <h3><?php echo $amberu_text_amberu_note . ': '; ?></h3>
			<textarea class="form-control" rows="5" name="amberu_note" placeholder="<?php echo $amberu_text_amberu_note; ?>"><?php echo $amberu_note; ?></textarea>
			<br/>
			<button id="button-amberu-note" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i> <?php echo $amberu_btn_amberu_note; ?></button>
		    <br/>
            <br/>
		  </div>
<script>
$('button#button-amberu-note').click( function(e) {

	$.ajax({
		url: 'index.php?route=sale/order/amberuEditAmberuNote&token=<?php echo $token; ?>',
		type: 'post',
		data: 'amberu_note=' + $('#tab-amberu-note textarea[name="amberu_note"]').val() + '&order_id=<?php echo $order_id; ?>',
		dataType: 'json',
		beforeSend: function(json) {
			$('#button-amberu-note').button('loading');
		},
		complete: function(json) {
			$('#button-amberu-note').button('reset');
		},
		success: function(json) {
			$('.alert').remove();
			if (json['success']) {
				$('#tab-amberu-note').append(
				...
				$('#tab-amberu-note').append(
					'<div class="alert alert-error">\
						...
						<i class="fa fa-check-circle"></i> ' + json['error'] + 
					'</div>'
				);
			}
		},
