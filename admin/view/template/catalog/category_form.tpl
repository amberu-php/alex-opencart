      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          <ul class="nav nav-tabs">
			...
			<li><a href="#tab-amberu-multiprice" data-toggle="tab"><?php echo "Amberu MultiPrice"; ?></a></li>
          ...
          <div class="tab-content">
			...
			<div class="tab-pane fade" id="tab-amberu-multiprice">
			  <h2>AMBERU MULTIPRICE</h2>
			  <div class="form-group">
				<label id="amberu-multiprice-label" class="col-sm-2 control-label" for="input-amberu-multiprice"><span data-toggle="tooltip" title="<?php echo "Сделать категорию мульти-ценовой"; ?>"><?php echo "Мульти-прайс-лист"; ?></span></label>
				<div class="col-sm-10">
				  <div class="checkbox">
					<label>
					  <?php if ($amberu_multiprice) { ?>
					  <input type="checkbox" name="amberu_multiprice" value="1" checked="checked" id="input-amberu-multiprice"  />
					  <?php } else { ?>
					  <input type="checkbox" name="amberu_multiprice" value="1" id="input-amberu-multiprice"  />
					  <?php } ?>
					  &nbsp; 
					</label>
				  </div>
