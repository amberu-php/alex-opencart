...
--
--AMBERU adding amberu_multiprice, (droped: amberu_pricelists)
...
CREATE TABLE IF NOT EXISTS `oc_category` (
  ...
  `amberu_multiprice` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `oc_customer` (
  ...
  `amberu_cart_p_n` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `oc_order` (
  ...
  `amberu_pricelist_number` int(11) NOT NULL DEFAULT '0',
  `amberu_note` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `oc_product` (
  ...
  `amberu_prices` text NOT NULL,
  `amberu_images_to_options` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `oc_product_image` (
  ...
  `amberu_option_value_id` int(11) NOT NULL DEFAULT '0',
...
--(280, 0, 'config', 'config_amberu_pricelists', 'a:1:{i:1;a:2:{s:11:"order_limit";s:1:"0";s:17:"customer_group_id";s:2:"-1";}}', 1);
