	...
	<div class="amberu-multiprice-container">
	  ...
	  <div class="amberu-multiprice-inner-container amberu-pricelist-select-container">
		...
		<?php   if(($amberu_pricelist['customer_group_id'] == -1) || ($amberu_pricelist['customer_group_id'] == $customer_group_id)) { ?>
				  <option value="<?php echo $product_href . '&amberu_pricelist_number=' . $amberu_key ?>" 
        ...
        <div class="<?php echo $class; ?>">
          <div class="product-thumb transition">
            ...
            <div class="button-group">
              <button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_cart; ?></span> <i class="fa fa-shopping-cart"></i></button>
              <!--//AMBERU-->
			  <!--IF FALSE-->
			   <?php if (FALSE) { ?>
					<button type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_wishlist; ?></span> <i class="fa fa-heart"></i></button>
					<button type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_compare; ?></span> <i class="fa fa-bar-chart"></i></button>
               <?php } ?>
