...
class ModelCheckoutOrder extends Model {
	public function addOrder($data) {
		...
		//AMBERU
		$this->db->query("UPDATE `" . DB_PREFIX . "order` SET amberu_pricelist_number = '" . $this->db->escape($this->session->data['amberu_cart']['pricelist_number']) . "' WHERE order_id = '" . (int)$order_id . "'");
	...
	public function editOrder($order_id, $data) {
		...
		//AMBERU
		$this->db->query("UPDATE `" . DB_PREFIX . "order` SET amberu_pricelist_number = '" . $this->db->escape(isset($this->session->data['amberu_cart']['pricelist_number']) ? $this->session->data['amberu_cart']['pricelist_number'] : 0) . "' WHERE order_id = '" . (int)$order_id . "'");
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				//amberu
				'amberu_pricelist_number' => $order_query->row['amberu_pricelist_number'],
