	...
	public function getProducts() {
		if (!$this->data) {
			foreach ($this->session->data['cart'] as $key => $quantity) {
				...
				//amberu
				$amberu_store_quantity = $product_query->row['quantity'];
				...
				if ($product_query->num_rows) {
							...
							if ($option_query->row['type'] == 'select' || $option_query->row['type'] == 'radio' || $option_query->row['type'] == 'image') {
								...
								if ($option_value_query->num_rows) {
									...
									if ($option_value_query->row['subtract']) {
										$amberu_store_quantity = ($amberu_store_quantity < $option_value_query->row['quantity']) ? $amberu_store_quantity : (int)$option_value_query->row['quantity'];
									}
					...
					$this->data[$key] = array(
						...
						'quantity'        => $quantity,
						//amberu
						'amberu_store_quantity' => $amberu_store_quantity,
					...
					//AMBERU
						//$_SESSION['amberu_pricelists']['cart'] = null;//debug
						if (isset($_SESSION['amberu_cart']['pricelist_number'])) {
